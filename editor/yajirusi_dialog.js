...
IslayPub.yajirusi_dialog = new function(){
	...
	this.open=function(target){
		...
		IslayPub.dialog.open(
			...
			"<div id='dialog_transition_condition'>◇"+IslayPub.language.transition_condition[lang]+"◇<br>"+
				"<select name = 'test' onchange='IslayPub.yajirusi_dialog.action_change([],0)' id = yazirushi_condition>"+//id追加した
			...
			"<select name = 'test1' onchange='IslayPub.yajirusi_dialog.action_change([],1)' id = yazirushi_condition1>"+//id追加した
				"<option value='transition_condition_none'>"+IslayPub.language.condition_none[lang]+"</option>"+
				"<option value='transition_condition_loop'>"+IslayPub.language.condition_loop[lang]+"</option>"+
				"<option value='transition_condition_clicked'>"+IslayPub.language.condition_clicked[lang]+"</option>"+
				"<option value='transition_condition_bump'>"+IslayPub.language.condition_bump[lang]+"</option>"+
			...
			"<select name = 'test2' onchange='IslayPub.yajirusi_dialog.action_change([],2)' id = yazirushi_condition2>"+//id追加した
				"<option value='transition_condition_none'>"+IslayPub.language.condition_none[lang]+"</option>"+
				"<option value='transition_condition_loop'>"+IslayPub.language.condition_loop[lang]+"</option>"+
				"<option value='transition_condition_clicked'>"+IslayPub.language.condition_clicked[lang]+"</option>"+
				"<option value='transition_condition_bump'>"+IslayPub.language.condition_bump[lang]+"</option>"+
			...
			"<div id='dialog_buttons'>"+
				"<input type='button' value='"+IslayPub.language.ok[lang]+"' ontouchend='if(IslayPub.yajirusi_dialog.apply(\"" + target.id + "\")){IslayPub.dialog.close();}'>"+
				"<input type='button' value='"+IslayPub.language.cancel[lang]+"' ontouchend='IslayPub.dialog.close();'>"+
				"<input type='button' value='"+IslayPub.language.apply[lang]+"' ontouchend='IslayPub.yajirusi_dialog.apply(\"" + target.id + "\");'>"+
				"<input type='button' value='"+IslayPub.language.add[lang]+"' ontouchend='IslayPub.yajirusi_dialog.add(\"" + target.id + "\");'>"+//IslayPub.yajirusi_dialog.open(\"" + target + "\");
			"</div>"+

			/*"<div id='dialog_buttons1'>"+
					"<input type='button' value='"+IslayPub.language.ok[lang]+"' ontouchend='if(IslayPub.yajirusi_dialog.apply(\"" + target.id + "\")){IslayPub.yajirusi_dialog.apply1(\"" + target.id + "\");IslayPub.dialog.close();}'>"+
					"<input type='button' value='"+IslayPub.language.cancel[lang]+"' ontouchend='IslayPub.dialog.close()'>"+
					"<input type='button' value='"+IslayPub.language.apply[lang]+"' ontouchend='IslayPub.yajirusi_dialog.apply(\"" + target.id + "\")'>"+
					"<input type='button' value='"+IslayPub.language.add[lang]+"' ontouchend='IslayPub.yajirusi_dialog.add(\"" + target.id + "\");'>"+
			"</div>"+*/
			...
			"<div id='dialog_buttons2'>"+
				"<input type='button' value='"+IslayPub.language.ok[lang]+"' ontouchend='if(IslayPub.yajirusi_dialog.apply(\"" + target.id + "\")){IslayPub.yajirusi_dialog.apply1(\"" + target.id + "\");IslayPub.yajirusi_dialog.apply2(\"" + target.id + "\");IslayPub.dialog.close();}'>"+
				"<input type='button' value='"+IslayPub.language.cancel[lang]+"' ontouchend='IslayPub.dialog.close()'>"+
				"<input type='button' value='"+IslayPub.language.apply[lang]+"' ontouchend='IslayPub.yajirusi_dialog.apply(\"" + target.id + "\");IslayPub.yajirusi_dialog.apply1(\"" + target.id + "\");IslayPub.yajirusi_dialog.apply2(\"" + target.id + "\");'>"+
			"</div>"
		...
		if(a){
			a = a.split(':');
			console.log(document.querySelector('option[value=transition_condition_' + a[0] + ']').selected);
	...
	*/
	this.action_change=function(init,num){
			console.log("num:"+num);
			if(num == 0){
				//console.log("num==0");
	...
	this.apply = function(target, recursive){
		console.log("apply:" + target + ":recursive:" + recursive);
